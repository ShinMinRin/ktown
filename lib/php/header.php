            ...
            <div class="col-sm-6">
                <div class="contactinfo">
                    <ul class="nav nav-pills">
                        <li><a href="#"><i class="fa fa-phone"></i> +32 2 520 14 12</a></li>
                        <li><a href="mailto:info@ktown.com"><i class="fa fa-envelope"></i> ktown.infos@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="logo pull-left">
                    <a href="index.php?page=accueil.php"><img src="images2/home/logo.png" alt="" /></a>
                </div>
            </div>
            <div class="col-sm-8">
